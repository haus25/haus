...
export function editProfile({ children }: editProfileProps) {
  const { 
    userProfile, 
    updateProfile, 
    uploadAvatar, 
      ...
      <DialogContent className="max-w-4xl w-full h-[90vh] p-0 sm:h-[85vh] flex flex-col">
        <DialogHeader className="px-4 sm:px-6 py-4 border-b flex-shrink-0">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-xl sm:text-2xl font-bold">Edit Profile & Settings</DialogTitle>
              <DialogDescription className="text-sm sm:text-base">
                Update your profile information, privacy settings, and preferences
              </DialogDescription>
            </div>
            <Button 
              variant="ghost" 
        ...
        <div className="flex h-full flex-col sm:flex-row overflow-hidden">
          <Tabs defaultValue="basics" orientation="vertical" className="w-full flex flex-col sm:flex-row h-full">
            {/* Navigation */}
            ...
            <div className="flex-1 min-h-0 overflow-hidden">
              <ScrollArea className="h-full">
                <div className="p-4 sm:p-6 space-y-6">
                  ...
                  {/* Basics Tab */}
                  <TabsContent value="basics" className="mt-0 space-y-4 sm:space-y-6">
                    {/* Profile Images */}
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div>
                          ...
                          <div
                            className="mt-2 h-32 rounded-lg overflow-hidden cursor-pointer group border-2 border-dashed border-muted hover:border-primary transition-colors"
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription className="text-sm">
                          Select up to 3 art categories you're interested in
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                          ...
                          <div key={key} className="flex items-center justify-between">
                            <div className="space-y-0.5">
                              ...
                              <p className="text-xs text-muted-foreground">
                                ...
                                {key === 'showTransactionHistory' && 'Show your transaction history publicly'}
                          ...
                          <div key={key} className="flex items-center justify-between">
                            <div className="space-y-0.5">
                              ...
                              <p className="text-xs text-muted-foreground">
                                ...
                                {key === 'weeklyDigest' && 'Receive a weekly summary of platform activity'}
                              </p>
                            </div>
                            <Switch
                              checked={value}
