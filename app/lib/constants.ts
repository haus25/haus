...
export const CONTRACT_ADDRESSES = {
  EVENT_FACTORY: process.env.NEXT_PUBLIC_EVENT_FACTORY || "0x0e228C9522bbe1cdcBEcB85ADDe1b828F671bfd4",
  EVENT_MANAGER: process.env.NEXT_PUBLIC_EVENT_MANAGER || "0x46caA3E209CC5dDd18AAC0d6e831D0FE64693E8F",
  CREATION_WRAPPER: process.env.NEXT_PUBLIC_CREATION_WRAPPER || "0x54F212af59842ea98b6DB4336b483A03fed23B3b",
  LIVE_TIPPING: process.env.NEXT_PUBLIC_LIVE_TIPPING || "0x6FCb17e00345df191242Fd0A1b8423E90B8bF442",
  DISTRIBUTOR: process.env.NEXT_PUBLIC_DISTRIBUTOR || "0xB0e3192a4d71362785103933e5200a749cb54be3",
}
